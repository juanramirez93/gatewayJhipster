...
To build the final jar and optimize the gatewayJhipster application for production, run:
...
Then navigate to [http://localhost:2801](http://localhost:2801) in your browser.
